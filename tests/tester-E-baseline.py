...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Running on the E benchmark")
    ...
    for dataset in datasets:
        ...
        for i, data in enumerate(dataloader):
            ...
            if len(processing_queue) >= args.batch_size or i == len(dataloader) - 1:
                for method in ["vsac", "MAGSAC OpenCV", "GCRANSAC OpenCV", "poselib", "pycolmap", "RANSAC OpenCV", "LMEDS OpenCV", "gcransac", "magsac", "magsac++"]:
                    for iters in [10, 25, 50, 100, 250, 500, 750, 1000, 1500, 2500, 5000, 7500, 10000]:
                        ...
                        # Print the pose errors in a csv format
                        for error, inlier_number, time in results:
                            print(f"{error[0]},{error[1]},{inlier_number},{time}")
