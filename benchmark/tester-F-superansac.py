...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Running on the F benchmark")
    ...
    if args.features == "splg":
        ...
        # Set the inlier threshold if not set to the tuned value
        if args.inlier_threshold < 0:
            args.inlier_threshold = 1.5
    ...
    # The output file
    out = f"results_testing_F_superansac_{args.features}.csv"
