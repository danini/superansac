...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Running on the benchmark")
    ...
    for dataset in datasets:
        ...
        out = f"tests/results_testing_H_superansac_{args.features}.csv"
